         ...
         <table  align="center" class="col- table table-striped  table-hover table-dark table-sm table-responsive">
            ...
            <tbody class="tabla">
              ...
              <tr>
                  ...
                  <td> {{ $registro->idMateria}}</td>
                  <td> {{ $registro->fecha}}</td>
                 <td colspan='2'>
                  <a href="{{route('Registros.edit', $registro->id )}}" class="btn btn-info glyphicon glyphicon-edit"></a>
                  <a class="btn btn-danger glyphicon glyphicon-trash" href="{{route('Registros.destroy', $registro->id )}}" onclick="event.preventDefault();document.getElementById('form').submit();"> </a>
                  {{ Form :: open([ 'method' => 'delete', 'id'=>'form','route'=>['Registros.destroy',$registro->id]])}}
