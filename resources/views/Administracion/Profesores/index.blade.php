         ...
         <table  align="center" class="col- table table-striped  table-hover table-dark table-sm table-responsive">
            ...
            <tbody class="tabla">
              ...
              <tr>
                 ...
                 <td colspan='2'>
                  <a href="{{route('Profesores.edit', $profesor->id )}}" class="btn btn-info glyphicon glyphicon-edit"></a>
                  <a class="btn btn-danger glyphicon glyphicon-trash" href="{{route('Profesores.destroy', $profesor->id )}}" onclick="event.preventDefault();document.getElementById('form').submit();"> </a>
                  {{ Form :: open([ 'method' => 'delete', 'id'=>'form','route'=>['Profesores.destroy',$profesor->id]])}}
