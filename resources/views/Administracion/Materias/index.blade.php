         ...
         <table  align="center" class="col- table table-striped  table-hover table-dark table-sm table-responsive">
            <thead >
               <tr class = "tabletitles" height = "55">
                  <th class="col-lg-1" >Abreviatura</th>
                  <th class="col-lg-5" >Materia</th>
                  <th class="col-lg-2" >Profesor</th>
                  <th class="col-lg-1" >Grupo</th>
                  <th colspan="5" class="col-lg-4">Edicion<a  class="glyphicon  plus btn-sm glyphicon-plus"  onClick="openDialog('popupAlumno')" /></th>
               </tr>
            </thead>
            <tbody class="tabla">
              ...
              <tr>
                 ...
                 <td>{{$materia->grupo}}</td>
                 <td colspan='2'>
                 <a href="{{route('Materias.edit', $materia->id )}}" class="btn btn-info glyphicon glyphicon-edit"></a>
                  <a class="btn btn-danger glyphicon glyphicon-trash" href="{{route('Materias.destroy', $materia->id )}}" onclick="event.preventDefault();document.getElementById('form').submit();"> </a>
                  {{ Form :: open([ 'method' => 'delete', 'id'=>'form','route'=>['Materias.destroy',$materia->id]])}}
