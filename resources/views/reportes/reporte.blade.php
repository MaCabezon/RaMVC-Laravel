           ...
           <div>
            <div class="col-md-12" style="padding-left: 10%;margin-bottom: 2%">
              <form class="form-inline form-filtro">
               <div class="col-md-3" style="float: left;">
                  ...
                  <div class="form-group col-md-12">
                    <h6>Fecha final</h6>
                    <input type="date" class="form-control col-md-2" id="fechaFinal" name="fechaFinal" max="<?php $hoy=date('Y-m-d'); echo $hoy; ?>">
                  </div>
              </div>
              ...
              @endforeach
                ...
                {!! Form::open(['route' => ['resumenAlumnos.excel'], 'method' => 'POST']) !!}
              <div class="col-md-5" >
               <div class="form-group col-md-12" >
                 <h6>Alumno</h6>
             ...
             <div class="form-group 7 col-md-4" style="margin-top: 5%;margin-left: 0%;margin-right: 0%">
               ...
               {!! Form::submit('Filtrar',['type' => 'submit', 'class' => 'btn btn-primary', 'method' => 'delete']) !!}
